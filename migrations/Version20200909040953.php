 ...
 */
final class Version20200909040953 extends AbstractMigration
{
    public function getDescription() : string
    {
        return 'Create CardiacEnzymes and ArterialBloodGas entities';
    }

    public function up(Schema $schema) : void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE SEQUENCE arterial_blood_gas_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE arterial_blood_gas_log_entries_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE cardiac_enzymes_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE cardiac_enzymes (id INT NOT NULL, cpk DOUBLE PRECISION DEFAULT NULL, miogoblin DOUBLE PRECISION DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE record ADD arterial_blood_gas_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE record ADD cardiac_enzymes_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP SEQUENCE arterial_blood_gas_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE arterial_blood_gas_log_entries_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE cardiac_enzymes_id_seq CASCADE');
